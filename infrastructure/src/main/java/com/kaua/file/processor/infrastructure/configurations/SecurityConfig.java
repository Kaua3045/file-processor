...
import com.kaua.file.processor.infrastructure.configurations.authentication.JwtConverter;
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize ->
                        authorize.requestMatchers("/v1/hello/test", "/v1/import-jobs/**").permitAll()
