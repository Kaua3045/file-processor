...
Um serviço de upload e processamento de arquivos, feito em Java com Spring Boot, utilizando clean architecture, DDD e SOLID. O projeto conta com deploy automatizado utilizando k8s, docker e argoCD.
...
```bash
git clone https://github.com/Kaua3045/file-processor.git
